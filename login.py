...
#separate login file that has log function called by Code.py file
...
def Log():
    ...
    # Top Frame
    top_frame = Label(Login, text='Login To System',font = ('Cosmic', 25, 'bold'), bg='lightgray',relief='groove',padx=500, pady=30)
    ...
    username_entry = tk.Entry(frame, font=('calibre',10,'normal'), justify = 'center', bg='lightblue')
    username_entry.bind('<Return>', Search)
    password_entry=tk.Entry(frame, font = ('calibre',10,'normal'), show = '*', justify = 'center', bg='lightblue') 
    password_entry.bind('<Return>', Search)
    
    # Button that will call the submit function  
    submit=tk.Button(frame,text = 'Login', command = Search, width="10",bd = '3',  font = ('Times', 12, 'bold'), bg='lightgray', fg='black',relief='groove', justify = 'center', pady='5') 
